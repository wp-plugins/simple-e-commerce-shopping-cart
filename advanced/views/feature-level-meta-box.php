...
<div class="inside">
  ...
  <p class="description">Note: You may have more subscription plans than feature levels. SimpleEcommCart uses feature levels, not the names of plans to manage permissions.</p>
  <input type="hidden" name="simpleecommcart_spreedly_meta_box_nonce" value="<?php echo wp_create_nonce('spreedly_meta_box') ?>" />
</div>
<?php else: ?>
  <div class="inside">
